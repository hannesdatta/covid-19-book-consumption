...
users_re_scrape<-fread("../../data/users_re_scrape.csv", sep=";") #save the data in a dataframe
...
drive_download(as_id(data_id), path = "../../data/stringency_index.csv", overwrite = TRUE) #download the data from the drive
...
drive_download(as_id(data_id), path = "../../data/books_re_scrape.csv", overwrite = TRUE) #download the data from the drive
...
drive_download(as_id(data_id), path = "../../data/all_users.csv", overwrite = TRUE) #download the data from the drive
all_users<-fread("../../data/all_users.csv", sep=";") #save the data in a dataframe
...
drive_download(as_id(data_id), path = "../../data/all_books.csv", overwrite = TRUE) #download the data from the drive
all_books<-fread("../../data/all_books.csv") #save the data in a dataframe
